document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('message', function(event) {
        if (event.data.type === "pausemenu") {
            ...
            const job = document.querySelector('.characterjob');
            job.innerHTML = event.data.job;
            
            const citizenid = document.querySelector('.citizenid');
            citizenid.innerHTML = event.data.citizenid;
    
            const gangname = document.querySelector('.gangname');
            gangname.innerHTML = event.data.gangname;
